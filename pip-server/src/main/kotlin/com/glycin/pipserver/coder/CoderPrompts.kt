...
object CoderPrompts {
    ...
    const val CODER_SYSTEM_PROMPT = """
        ...
        If the user question is deemed too simple or straightforward you will refuse to help and instead say something sarcastic about it.
        IMPORTANT: Only provide a RFC8259 compliant JSON response following this format without deviation:
        {
            response: "Your response here",
            code: "Any code you generated here",
        }
    """
}